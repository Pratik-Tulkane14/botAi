...
interface InputBox {
    setBotAiResponse: React.Dispatch<
        React.SetStateAction<{ id: number; question: string; response: string }[]>
    >;
}

const InputBox = ({ setBotAiResponse }: InputBox) => {
    ...
    return (
        <form
            ...
            className="grid grid-cols-3 md:grid-cols-7 gap-5 items-center sticky bottom-0 bg-gray-200 px-4 py-8 mt-[14rem]"
        >
            ...
            <div className="col-span-1 flex gap-5">
                <Button variant="filled" type="submit" color="gray">
                    Ask
                </Button>
